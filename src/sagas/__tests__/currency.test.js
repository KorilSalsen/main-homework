...
describe('currency saga', () => {
  ...
  describe('currencyWatch', () => {
    ...
    it('1. Effect take loginSuccess, logout, selectBtc, selectEth, selectOffset', () => {
      expect(saga.next().value).toEqual(take([loginSuccess, logout, selectBtc, selectEth, selectOffset]));
    });
    ...
    it('3. Effect take loginSuccess, logout, selectBtc, selectEth, selectOffset', () => {
      expect(saga.next(currencyTask).value).toEqual(take([loginSuccess, logout, selectBtc, selectEth, selectOffset]));
    });
  ...
  describe('fetchBtcWatch', () => {
    ...
    it('Effect takeLatest fetchBtcRequest', () => {
      expect(saga.next().value).toEqual(takeLatest(fetchBtcRequest, fetchBtcFlow));
    });
  });
  ...
  describe('fetchEthWatch', () => {
    ...
    it('Effect takeLatest fetchEthRequest', () => {
      expect(saga.next().value).toEqual(takeLatest(fetchEthRequest, fetchEthFlow));
    });
  });
