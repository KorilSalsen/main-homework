...
import { getBtcSell, getEthSell, getBtcBuy, getEthBuy, getSelected } from '../../reducers/currency';
      ...
      <div className="market">
        ...
        <div className="row">
          <MarketField
            ...
            onBlur={this.blurHandler}
          />
          <button className="btn sell" name="sell" onClick={this.trade}>Продать</button>
        </div>
        <div className="row">
          <MarketField
            name="buy"
            ...
            onBlur={this.blurHandler}
          />
          <button className="btn purchase" name="buy" onClick={this.trade}>Купить</button>
        </div>
      </div>
    );
  }
